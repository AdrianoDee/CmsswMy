                                              ...
                                              const SeedingLayerSetsHits::SeedingLayerSet& fourLayers)
{
    ...
    */
    ...
    auto const & doublets2 = theDoubletsCache->getDoublets(fourLayers[1],fourLayers[2],&middleTree,region,ev,es);
    ...
    auto const & doublets3 = theDoubletsCache->getDoublets(fourLayers[2],fourLayers[3],&outerTree,region,ev,es);
