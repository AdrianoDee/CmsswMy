                                              ...
                                              const SeedingLayerSetsHits::SeedingLayerSet& fourLayers)
{
    ...
    LayerTree treeFirst;
    std::cout<<"Checking cache for id : "<< <<std::endl;
    if(theKDTreeCache.checkCache(fourLayers[0].index())){
        std::cout<<"Tree already done "<<fourLayers[0].index()<<std::endl;
    ...
    LayerTree & treeFirst;
    = theKDTreeCache(fourLayers[0],region,ev,es);//treeFirst.FKDTree<float,3>::make_FKDTreeFromRegionLayer(fourLayers[0],region,ev,es);
    ...
    */
    ...
    auto const & doublets1 = caDoubletsGenerator.doublets(region,ev,es,fourLayers[0],fourLayers[1],layersHitsTree[0]);
    ...
    auto const & doublets2 = caDoubletsGenerator.doublets(region,ev,es,fourLayers[1],fourLayers[2],layersHitsTree[1]);
    ...
    auto const & doublets3 = caDoubletsGenerator.doublets(region,ev,es,fourLayers[2],fourLayers[3],layersHitsTree[2]);
