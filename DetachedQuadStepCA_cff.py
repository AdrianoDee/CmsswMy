...
from RecoPixelVertexing.PixelTriplets.PixelQuadrupletGenerator_cfi import PixelQuadrupletGenerator as _PixelQuadrupletGenerator ##Configurazioni
...
##Imposta il generatore di tripletti
##PixelQuads->COmbined->
eras.trackingPhase1.toModify(detachedQuadStepSeeds,
    OrderedHitsFactoryPSet = cms.PSet(
        ComponentName = cms.string("CombinedHitQuadrupletGeneratorCA"),
